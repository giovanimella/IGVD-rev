              ...
              selectedDateAppointments.length > 0 ? (
                <div className="space-y-3">
                  {selectedDateAppointments.map((apt) => {
                    ...
                    const isCompanyEvent = apt.is_company_event;
                    ...
                    return (
                      <div
                        ...
                        className={`p-4 rounded-lg border transition-colors ${
                          isCompanyEvent 
                            ? 'border-yellow-300 dark:border-yellow-500/50 bg-yellow-50/50 dark:bg-yellow-900/10 hover:border-yellow-400 dark:hover:border-yellow-500' 
                      ...
                      >
                        <div className="flex items-start justify-between">
                          <div className="flex items-start gap-3">
                            <div className={`w-10 h-10 rounded-lg ${catInfo.color} flex items-center justify-center flex-shrink-0 ${isCompanyEvent ? 'ring-2 ring-yellow-400' : ''}`}>
